...
json_file_path = "../data/rad_trainset_llava_COT.json"

# Paths to your template files
template_path = "../data/rad_task_cot_related_template.py"
...
for item in tqdm(data, desc="Processing Images"):
    ...
    response = requests.post("https://chat.openai.com/", headers=headers, json=payload)
    ...
    if response.ok:
        ...
        # 保存更新后的对话到JSON文件
        updated_json_file_path = "/Users/wuzhongze/Documents/workspace/MLLM/LLaVA-Med-main/data/downstream_data/data_RAD_old/train_COT_task_related_remain170.json"
