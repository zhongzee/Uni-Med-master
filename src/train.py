...
@dataclass
class DataArguments:
    img_dir: str = field(default='/root/autodl-tmp/Uni/Uni_images1', metadata={"help": "Path to the training data."})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: Optional[str] = field(default="/root/autodl-tmp/Uni/Results/PMC_llama13B_PMCCLIP_QA_pretrain_no_aug-test1")
